...
type ContextType = {
  ...
  renderCell?: (date: Date, events: CalendarEvent[]) => React.ReactNode;
...
const CalendarMonthView = () => {
  const { date, view, events, locale, onEventClick, onClick, renderCell } = useCalendar();
          ...
          if (renderCell) {
            return (
                <div
                  ...
                  key={_date.toString()}
                >
                  {renderCell(_date, currentEvents)}
                </div>
            );
          }
